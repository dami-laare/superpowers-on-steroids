...
**Mandatory:**
- After each task in subagent-driven development — in fast mode, except a transcription task closed by SDD's Review tier gate (a plan-set tier, not the controller's own "it's simple" judgment)
